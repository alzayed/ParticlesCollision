var colors = ['red', 'blue', 'green', 'yellow', 'pink', 'cyan'];
...
function isTouchCeilOrGround(particle) {
    ...
    if(particle.y + particle.radius >= canv.height) {
        particle.y = canv.height - particle.radius;
    } 
...
function isTouchRightOrLeftSides(particle) {
    ...
    if(particle.x + particle.radius >= canv.width) {
        particle.x = canv.width - particle.radius;
    } 
...
function resolveCollision(particle, otherParticle) {
    ...
    if(particle.color === 'red') {
        ...
        for(var i = 0; i < particles.length; i++){
            if (particles[i] === otherParticle) {
                particles.splice(i, 1); 
            }
        }
    }

    if(otherParticle.color === 'red') {
        otherParticle.radius += 1;
        for(var i = 0; i < particles.length; i++){ 
